export const RNID_PERMISSION_FLAGS = {
	...
	UPDATE_RNID_PERMISSIONS: 1n << 20n
} as const;

export type RNIDPermissionFlag = (typeof RNID_PERMISSION_FLAGS)[keyof typeof RNID_PERMISSION_FLAGS];