...
router.post('/', async (request, response) => {
	...
	const accessTokenBuffer = await util.generateToken(config.aes_key, accessTokenOptions);
	const refreshTokenBuffer = await util.generateToken(config.aes_key, refreshTokenOptions);
