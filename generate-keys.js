...
async function main() {
	...
	logger.log('Created output directories!');
	...
	logger.log('Exported public key!');

	// Saving public key
	logger.info('Saving public key to disk...');
	fs.writeFileSync(publicKeyPath, publicKey);
	logger.log(`Saved public key to ${publicKeyPath}!`);

	logger.info('Exporting private key...');
	const privateKey = key.exportKey('private');
	logger.log('Exported private key!');

	// Saving private key
	logger.info('Saving private key to disk...');
	fs.writeFileSync(privateKeyPath, privateKey);
	logger.log(`Saved private key to ${privateKeyPath}!`);
	...
	logger.log(`Saved AES key to ${aesKeyPath}!`);
	...
	logger.log(`Saved HMAC secret to ${secretKeyPath}!`);
